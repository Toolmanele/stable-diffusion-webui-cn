...
def run_pip(command, desc=None, live=default_command_live):
    ...
    index_url_line = f" --index-url https://pypi.tuna.tsinghua.edu.cn/simple"
    return run(
...
def version_check(commit):
    try:
        ...
        commits = requests.get(
            "https://gitee.com/api/v5/repos/Toolmanele/stable-diffusion-webui-cn/branches/master"
        ).json()
...
def prepare_environment():
    ...
    torch_command = os.environ.get(
        "TORCH_COMMAND",
        f"pip install torch==2.1.2 torchvision==0.16.2 -f {torch_index_url} -i {pip_index_url}",
    )
    if args.use_ipex:
    ...
    # https://gitee.com/cafetime/CLIP/repository/archive/d50d76daa670286dd6cacf3bcd80b5e4823fc8e1.zip
    # https://gitcode.com/gh_mirrors/cl/CLIP/archive/d50d76daa670286dd6cacf3bcd80b5e4823fc8e1.zip
    # https://gitee.com/Toolmanele/CLIP/releases/download/d50d76/CLIP-d50d76daa670286dd6cacf3bcd80b5e4823fc8e1.zip
    clip_package = os.environ.get(
        "CLIP_PACKAGE",
        "https://gitee.com/Toolmanele/CLIP/releases/download/d50d76/CLIP-d50d76daa670286dd6cacf3bcd80b5e4823fc8e1.zip",
    )
    # https://github.com/mlfoundations/open_clip/archive/bb6e834e9c70d9c27d0dc3ecedeebeaeb1ffad6b.zip
    # https://gitee.com/Toolmanele/open_clip/releases/download/bb6e83/open_clip-bb6e834e9c70d9c27d0dc3ecedeebeaeb1ffad6b.zip
    openclip_package = os.environ.get(
        "OPENCLIP_PACKAGE",
        "https://gitee.com/Toolmanele/open_clip/releases/download/bb6e83/open_clip-bb6e834e9c70d9c27d0dc3ecedeebeaeb1ffad6b.zip",
    )

    # https://gitee.com/Toolmanele/stable-diffusion-webui-assets.git
    # https://gitee.com/Toolmanele/stable-diffusion-webui-assets.git
    ...
    # https://gitcode.com/gh_mirrors/st/stablediffusion.git
    stable_diffusion_repo = os.environ.get(
        "STABLE_DIFFUSION_REPO", "https://gitcode.com/gh_mirrors/st/stablediffusion.git"
    )
    # https://github.com/Stability-AI/generative-models.git
    # https://gitcode.com/gh_mirrors/ge/generative-models.git
    stable_diffusion_xl_repo = os.environ.get(
        "STABLE_DIFFUSION_XL_REPO",
        "https://gitcode.com/gh_mirrors/ge/generative-models.git",
    )
    # https://github.com/crowsonkb/k-diffusion.git
    # https://gitcode.com/gh_mirrors/kd/k-diffusion.git
    k_diffusion_repo = os.environ.get(
        "K_DIFFUSION_REPO", "https://gitcode.com/gh_mirrors/kd/k-diffusion.git"
    )
    # https://github.com/salesforce/BLIP.git
    # https://gitcode.com/gh_mirrors/bl/BLIP.git
    blip_repo = os.environ.get(
        "BLIP_REPO", "https://gitcode.com/gh_mirrors/bl/BLIP.git"
    )
